...
public class WeatherForecastLayout extends LinearLayout {
    ...
    private String iconToText(String code) {
        ...
        //Met.No
        if (code.equals("clearsky") || code.equals("clearsky_day")) return "B";
        if (code.equals("fair") || code.equals("fair_day")) return "H";
        if (code.equals("heavyrain") || code.equals("heavyrain_day")) return "R";
        if (code.equals("heavyrainandthunder") || code.equals("heavyrainandthunder_day")) return "P";
        if (code.equals("heavyrainshowers") || code.equals("heavyrainshowers_day")) return "R";
        if (code.equals("heavyrainshowersandthunder") || code.equals("heavyrainshowersandthunder_day")) return "O";
        if (code.equals("heavysleet") || code.equals("heavysleet_day")) return "U";
        if (code.equals("heavysleetandthunder") || code.equals("heavysleetandthunder_day")) return "O";
        if (code.equals("heavysleetshowers") || code.equals("heavysleetshowers_day")) return "U";
        if (code.equals("heavysleetshowersandthunder") || code.equals("heavysleetshowersandthunder_day")) return "O";
        if (code.equals("heavysnow") || code.equals("heavysnow_day")) return "W";
        if (code.equals("heavysnowandthunder") || code.equals("heavysnowandthunder_day")) return "O";
        if (code.equals("heavysnowshowers") || code.equals("heavysnowshowers_day")) return "U";
        if (code.equals("heavysnowshowersandthunder") || code.equals("heavysnowshowersandthunder_day")) return "O";
        if (code.equals("lightrain") || code.equals("lightrain_day")) return "Q";
        if (code.equals("lightrainandthunder") || code.equals("lightrainandthunder_day")) return "O";
        if (code.equals("lightrainshowers") || code.equals("lightrainshowers_day")) return "Q";
        if (code.equals("lightrainshowersandthunder") || code.equals("lightrainshowersandthunder_day")) return "O";
        if (code.equals("lightsleet") || code.equals("lightsleet_day")) return "U";
        if (code.equals("lightsleetandthunder") || code.equals("lightsleetandthunder_day")) return "O";
        if (code.equals("lightsleetshowers") || code.equals("lightsleetshowers_day")) return "U";
        if (code.equals("lightsnow") || code.equals("lightsnow_day")) return "U";
        if (code.equals("lightsnowandthunder") || code.equals("lightsnowandthunder_day")) return "O";
        if (code.equals("lightsnowshowers") || code.equals("lightsnowshowers_day")) return "U";
        if (code.equals("lightssleetshowersandthunder") || code.equals("lightssleetshowersandthunder_day")) return "O";
        if (code.equals("lightssnowshowersandthunder") || code.equals("lightssnowshowersandthunder_day")) return "O";
        if (code.equals("partlycloudy") || code.equals("partlycloudy_day")) return "H";
        if (code.equals("rainandthunder") || code.equals("rainandthunder_day")) return "O";
        if (code.equals("rainshowers") || code.equals("rainshowers_day")) return "R";
        if (code.equals("rainshowersandthunder") || code.equals("rainshowersandthunder_day")) return "O";
        if (code.equals("sleetandthunder") || code.equals("sleetandthunder_day")) return "O";
        if (code.equals("sleetshowers") || code.equals("sleetshowers_day")) return "X";
        if (code.equals("sleetshowersandthunder") || code.equals("sleetshowersandthunder_day")) return "O";
        if (code.equals("snowandthunder") || code.equals("snowandthunder_day")) return "O";
        if (code.equals("snowshowers") || code.equals("snowshowers_day")) return "U";
        if (code.equals("snowshowersandthunder") || code.equals("snowshowersandthunder_day")) return "O";

        if (code.equals("clearsky_night")) return "2";
        if (code.equals("fair_night")) return "4";
        if (code.equals("heavyrain_night")) return "8";
        if (code.equals("heavyrainandthunder_night")) return "6";
        if (code.equals("heavyrainshowers_night")) return "8";
        if (code.equals("heavyrainshowersandthunder_night")) return "6";
        if (code.equals("heavysleet_night")) return "\"";
        if (code.equals("heavysleetandthunder_night")) return "6";
        if (code.equals("heavysleetshowers_night")) return "\"";
        if (code.equals("heavysleetshowersandthunder_night")) return "6";
        if (code.equals("heavysnow_night")) return "#";
        if (code.equals("heavysnowandthunder_night")) return "6";
        if (code.equals("heavysnowshowers_night")) return "\"";
        if (code.equals("heavysnowshowersandthunder_night")) return "6";
        if (code.equals("lightrain_night")) return "7";
        if (code.equals("lightrainandthunder_night")) return "6";
        if (code.equals("lightrainshowers_night")) return "7";
        if (code.equals("lightrainshowersandthunder_night")) return "6";
        if (code.equals("lightsleet_night")) return "\"";
        if (code.equals("lightsleetandthunder_night")) return "6";
        if (code.equals("lightsleetshowers_night")) return "\"";
        if (code.equals("lightsnow_night")) return "\"";
        if (code.equals("lightsnowandthunder_night")) return "6";
        if (code.equals("lightsnowshowers_night")) return "\"";
        if (code.equals("lightssleetshowersandthunder_night")) return "6";
        if (code.equals("lightssnowshowersandthunder_night")) return "6";
        if (code.equals("partlycloudy_night")) return "4";
        if (code.equals("rainandthunder_night")) return "6";
        if (code.equals("rainshowers_night")) return "8";
        if (code.equals("rainshowersandthunder_night")) return "6";
        if (code.equals("sleetandthunder_night")) return "6";
        if (code.equals("sleetshowers_night")) return "$";
        if (code.equals("sleetshowersandthunder_night")) return "6";
        if (code.equals("snowandthunder_night")) return "6";
        if (code.equals("snowshowers_night")) return "\"";
        if (code.equals("snowshowersandthunder_night")) return "6";
