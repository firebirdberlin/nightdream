...
public class CustomAnalogClock3 extends CustomAnalogClock {
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawArc(canvas, center, radius, min_angle);

        paint.setColorFilter(secondaryColorFilter);
        drawArc(canvas, center, radius - 40, hour_angle);
...
/*
    ...
    private void drawArc(Canvas canvas, Point center, int radius, double angle) {
